...
static const R_CMethodDef CEntries[] = {
  {"arck4_mv_boot",     (DL_FUNC) &arck4_mv_boot,     10},
  {"arceqfit_bc",       (DL_FUNC) &arceqfit_bc,       13},
  {"arceqfit_bc_boot",  (DL_FUNC) &arceqfit_bc_boot,  13},
  {"arceqfit_k4eq",     (DL_FUNC) &arceqfit_k4eq,     12},
  {"arceqfit_k4eq_boot",(DL_FUNC) &arceqfit_k4eq_boot,14},
  {"arceqfit_msim",     (DL_FUNC) &arceqfit_msim,     14},
  {"arceqfit_score_at", (DL_FUNC) &arceqfit_score_at, 8},
  {"arceqfit_blocklen", (DL_FUNC) &arceqfit_blocklen, 3},
  {"arceqfit_nullT",    (DL_FUNC) &arceqfit_nullT,    13},
  {"arceqfit_estsim",   (DL_FUNC) &arceqfit_estsim,   8},
  {"arceqfit_taus",     (DL_FUNC) &arceqfit_taus,     6},
  {"arceqfit_bsweep",   (DL_FUNC) &arceqfit_bsweep,   4},
  {"arceqfit_absweep",  (DL_FUNC) &arceqfit_absweep,  5},
  {"arceqfit_Esweep",   (DL_FUNC) &arceqfit_Esweep,   4},
  {"arcvc_icc_oneway",  (DL_FUNC) &arcvc_icc_oneway,  5},
  {"arcvc_locus_dist",  (DL_FUNC) &arcvc_locus_dist,  7},
  ...
  {"al_band_model_star",(DL_FUNC) &al_band_model_star,5},
  {"al_band_sample",    (DL_FUNC) &al_band_sample,    5},
  {"al_scale",          (DL_FUNC) &al_scale,          5},
  {"al_scale_raw",      (DL_FUNC) &al_scale_raw,      5},
  ...
  {"arck4_band_model",  (DL_FUNC) &arck4_band_model,  6},
  {"arck4_band_sample", (DL_FUNC) &arck4_band_sample, 7},
  ...
  {"arck4_fit_nls_drift", (DL_FUNC) &arck4_fit_nls_drift, 5},
  {"arck4_fit_varpro",  (DL_FUNC) &arck4_fit_varpro,  9},
  {"arck4_band_trop_mean", (DL_FUNC) &arck4_band_trop_mean, 7},
  {"arck4_fit_nalr",    (DL_FUNC) &arck4_fit_nalr,    9},
  ...
  {"arcc_exact_ci",      (DL_FUNC) &arcc_exact_ci,      10},
  {"arcc_gof",           (DL_FUNC) &arcc_gof,            7},
